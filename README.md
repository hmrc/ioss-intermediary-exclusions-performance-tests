# ioss-intermediary-exclusions-performance-tests

Performance test suite for the `ioss-intermediary-exclusions-frontend`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
